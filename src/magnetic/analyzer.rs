...
///
/// # Örnek (batch — 2D harita satırı / tarama dizisi)
/// ```
/// use votex::{MagneticAnalyzer, MagneticConfig};
///
/// let raw = vec![-1160.0, -200.0, 0.0, 50.0, 470.0];
/// let mut analyzer = MagneticAnalyzer::new(MagneticConfig::default());
/// let map = analyzer.analyze_batch(&raw);
