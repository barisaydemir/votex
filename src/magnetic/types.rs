...
pub struct MagneticConfig {
    ...
    /// Ekrandaki ~±19 birimlik nötr bölgeye yakın.
...
impl Default for ColorPalette {
    fn default() -> Self {
        Self {
            // Canlı yeşil zemin (Proton ELIC)
            neutral: Rgba::rgb(34, 180, 70),
            positive_stops: [
                Rgba::rgb(34, 180, 70),   // yeşil
                Rgba::rgb(255, 230, 40),  // sarı
                Rgba::rgb(255, 140, 20),  // turuncu
                Rgba::rgb(220, 20, 20),   // saf kırmızı (peak+)
            ],
            negative_stops: [
                Rgba::rgb(34, 180, 70),   // yeşil
                Rgba::rgb(80, 200, 230),  // açık mavi / cyan
                Rgba::rgb(20, 40, 180),   // koyu mavi (peak-)
            ],
        }
    }
}
